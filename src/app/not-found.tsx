          ...
          <div className="w-full min-h-96 flex flex-col md:flex-row justify-center gap-4 items-center md:justify-between">
            <div className="w-full md:w-1/2 flex justify-center items-center">
              <div className="bg-red-400 rounded-md text-center text-black p-4 flex flex-col gap-4">
                <p>
                  Lamentamos informar que página que tentou acessar{' '}
                  <strong>não existe</strong> ou está{' '}
                  <strong>indisponível.</strong>
                </p>
                <p>
                  Volte para o dashboard e tente novamente ou entre em contato
                </p>
              </div>
            </div>
            <div className="w-full md:w-1/3">
              <Image src={notFound} quality={100} alt="Página não encontrada" />
            </div>
          </div>
